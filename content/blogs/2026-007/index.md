...
The distal-CRE magnitude question — much bigger perturbations, disabling a whole regulatory element — has received little attention since [Karollus et al., 2023](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-023-02899-9). They defined an _in-silico_ CRISPRi benchmark on [Fulco 2019](https://pubmed.ncbi.nlm.nih.gov/31784727/) and [Gasperini 2019](https://pubmed.ncbi.nlm.nih.gov/30612741/) and ran it on Enformer and Basenji2, finding both substantially undershoot real enhancer effects. AlphaGenome's paper tests enhancer-gene linking (a classification task) on the [ENCODE-rE2G CRISPRi dataset](https://www.biorxiv.org/content/10.1101/2023.11.09.563812v1), notes that even AlphaGenome underestimates the impact of very distal enhancers, but doesn't run the magnitude-prediction benchmark. Borzoi and NTv3 have also followed Enformer, all three claiming gains from longer contexts and broader predictive tasks — yet none have been evaluated on Karollus's magnitude-prediction benchmark.
...
12. Gschwind, A.R. et al. An encyclopedia of enhancer-gene regulatory interactions in the human genome. _bioRxiv_ (2023). https://doi.org/10.1101/2023.11.09.563812